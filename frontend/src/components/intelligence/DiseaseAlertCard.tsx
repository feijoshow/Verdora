...
const styles = StyleSheet.create({
  ...
  title: { ...typography.h3, fontSize: 15, color: colors.primaryDark, flex: 1 },
  ...
  badgeText: { fontSize: 10, fontWeight: '700', color: colors.secondaryDark },
  stats: { ...typography.caption, marginTop: spacing.xs, fontWeight: '600' },
  message: { ...typography.bodySmall, marginTop: spacing.sm, lineHeight: 20 },
  ...
  mapMeta: { flex: 1 },
  metaLine: { ...typography.caption, marginTop: 2 },
